...
function file_video(path) {
  ...
  const playBtn = `
      <button class="mdui-btn mdui-ripple mdui-color-theme-accent" mdui-menu="{target:'#player-items'}">
        <i class="mdui-icon material-icons">&#xe039;</i>External Player<i class="mdui-icon material-icons">&#xe5cf;</i>
      </button>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML Embeded</label>
...
//# sourceMappingURL=/sm/b5483e72c3ea91ab799f73588495a128f9f39af2d0ff8a4180e49b85348576c6.map